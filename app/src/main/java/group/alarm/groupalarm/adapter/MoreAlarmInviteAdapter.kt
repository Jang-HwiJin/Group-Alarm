...
class MoreAlarmInviteAdapter : RecyclerView.Adapter<MoreAlarmInviteAdapter.ViewHolder> {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MoreAlarmInviteAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: MoreAlarmInviteAdapter.ViewHolder, position: Int) {
