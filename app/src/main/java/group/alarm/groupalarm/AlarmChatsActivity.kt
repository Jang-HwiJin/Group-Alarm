...
import group.alarm.groupalarm.adapter.ChatsAdapter
import group.alarm.groupalarm.data.Alarm
import group.alarm.groupalarm.data.Messages
import group.alarm.groupalarm.data.User
import group.alarm.groupalarm.databinding.ActivityAlarmChatsBinding
import group.alarm.groupalarm.dialog.LeaveAlarmDialog
    ...
    private fun setupNavigationView(alarmId: String) {
        ...
        inviteUsers.setOnClickListener {
            ...
            intentDetails.setClass(
                this, group.alarm.groupalarm.MoreAlarmInviteActivity::class.java
            )
